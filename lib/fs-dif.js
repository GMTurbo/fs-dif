...
var fsDif = function(options) {
  ...
  var beginWatch = function() {
    ...
    //this function is gonna have to check the filters somehow
    var filterThese = function(dirFilter, fileFilter) {
      ...
      */
      ...
      debugger;
      var fileFilterMM = helpers.normalizeFilter(fileFilter) || function(){return true;};
      var directoryFilterMM = helpers.normalizeFilter(dirFilter) || function(){return true;};
